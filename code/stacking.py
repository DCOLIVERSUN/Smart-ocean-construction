...
clf = RandomForestClassifier(n_estimators=1500, criterion='gini', verbose=0,random_state=2048,oob_score=True)
clf.fit(newfeature, target)
ans = clf.predict(newtestdata)
res['type'] = ans
