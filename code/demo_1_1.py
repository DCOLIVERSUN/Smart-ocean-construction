...
train_data.drop(['x_1/2','low_lon_ratio','medium_lon_ratio','x_max_x_min'], axis=1,inplace=True)
###############
...
test_data.drop(['x_1/2', 'low_lon_ratio', 'medium_lon_ratio', 'x_max_x_min'], axis=1, inplace=True)
###############
...
print('Tag 1.1, XGB mean F1 Score: ' + str(np.mean(scores)))
################

################
# 保存结果

np.savetxt('result_1.txt', prediction)
################